...
_COACHES = [
    {'name': '김귀연',   'jobTitle': '유아교육·아동발달 코치'},
    {'name': '김용순',   'jobTitle': '국제정치·북한연구 코치'},
    {'name': '김재환',   'jobTitle': '조직문화·리더십 코치'},
    {'name': '김태영',   'jobTitle': '진로상담·조직코칭 코치'},
    {'name': '김희상',   'jobTitle': 'IT·블록체인 코치'},
    {'name': '박미진',   'jobTitle': '서비스·고객만족 코치'},
    {'name': '방병권',   'jobTitle': 'HR 데이터분석·채용 코치'},
    {'name': '박일용',   'jobTitle': '운동처방·웰니스 코치'},
    {'name': '신혜림',   'jobTitle': '화장품산업교육·시니어심리 코치'},
    {'name': '안세영',   'jobTitle': '비즈니스전략·지속가능경영 코치'},
    {'name': '안희수',   'jobTitle': '강점코칭·예술인문학 코치'},
    {'name': '왕소빈',   'jobTitle': 'HR 기반 직무·취업전략 코치'},
    {'name': '우소연',   'jobTitle': '스피치·이미지메이킹 코치'},
    {'name': '유예림',   'jobTitle': '중국어교육·문화언어학 코치'},
    {'name': '유장현',   'jobTitle': '조직개발·리더십컨설팅 코치'},
    {'name': '윤태일',   'jobTitle': '취업전략·실전코칭 코치'},
    {'name': '이유나',   'jobTitle': '진로상담·디지털인문학 코치'},
    {'name': '이은선',   'jobTitle': '조직문화·커뮤니케이션 코치'},
    {'name': '이주노',   'jobTitle': 'UX·데이터 시각화 코치'},
    {'name': '이현주',   'jobTitle': '예술인문학 코치'},
    {'name': '정다운',   'jobTitle': '진로설계·커리어전략 코치'},
    {'name': '정종우',   'jobTitle': '산업안전·조직관리 코치'},
    {'name': '정지혜',   'jobTitle': '관광·외식 운영 및 진로지도 코치'},
    {'name': '전성은',   'jobTitle': '리더십·커뮤니케이션 코치'},
    {'name': '전예슬',   'jobTitle': '수학·MBA·디자인·사회과학 코치'},
    {'name': '최지혜',   'jobTitle': '취업·커리어 컨설팅 코치'},
    {'name': '최해령',   'jobTitle': '마인드셋·자기관리 코치'},
    {'name': 'Steve Kim', 'jobTitle': '보딩스쿨·미국유학 전문 코치'},
    {'name': 'LEAH',     'jobTitle': '교육학·대학원 코칭 코치'},
]
